module "service_instance" {
  ...
  source  = "git@github.com:KL-Engineering/${{ values.product_name }}-terraform-svc.git?ref=v0.4.0"
  ...
  # Helm
  helm_chart_url                   = "git@github.com:KL-Engineering/${{ values.product_name }}-gitops-env.git"
